...
function startpoint_optionsframework_options_page() {
	...
	<div class="trail-notify">
        ...
        <a href="http://www.inkthemes.com/startpoint-business-one-page-wordpress-theme/" target="blank">Upgrade to StartPoint PRO Theme here >></a>
    </div>
        ...
        foreach ($options as $option) {
            if ($option['type'] == 'color' OR $option['type'] == 'typography' OR $option['type'] == 'border') {
                if ($option['type'] == 'typography' OR $option['type'] == 'border') {
                    $option_id = $option['id'];
                    $temp_color = startpoint_get_option($option_id);
                    $option_id = $option['id'] . '_color';
                    $color = $temp_color['color'];
                } else {
                    $option_id = $option['id'];
                    $color = startpoint_get_option($option_id);
                }
                ?>
